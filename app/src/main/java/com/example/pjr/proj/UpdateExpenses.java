...
public class UpdateExpenses extends Activity implements OnTabActivityResultListener {
    //上方按钮及栏目
    ...
    void setView(final String id) {
        ...
        while (cursor.moveToNext()) {
            if(cursor.getInt(cursor.getColumnIndex("id"))==Integer.parseInt(id) && cursor.getInt(cursor.getColumnIndex("bookid"))==Integer.parseInt(bookid)) {
                expensesTypeName.setText(cursor.getString(cursor.getColumnIndex("classname")));
                double money=cursor.getDouble(cursor.getColumnIndex("number"));
                String s=String .format("%.2f",money);
                expensesMoney.setText("￥"+s);
...
//                String day=Integer.toString(cursor.getInt(cursor.getColumnIndex("day")));
    ...
    //计算器相关
    void calculater(final String id) {
        //点击数字按钮输入数字
            ...
            public void onClick(View view) {
                ...
                if(pointFlag==false) {
                    ...
                    //超过位数
                        ...
                        Toast.makeText(UpdateExpenses.this,"最多只能输入七位整数", Toast.LENGTH_SHORT).show();
                    }
                }
                //输入小数点时
                else {
                    ...
                    //超过位数
                        ...
                        Toast.makeText(UpdateExpenses.this,"最多只能输入两位小数", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        ...
        point.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //输入过小数点时
                    ...
                    Toast.makeText(UpdateExpenses.this,"不能输入两次小数点", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        OK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //OK按钮时
                    ...
                    AccountItem accountItem=new AccountItem(0,OUT,expensesTypeName.getText().toString(),number,descrip,
                            Integer.parseInt(year1),Integer.parseInt(month1),Integer.parseInt(day1),Integer.parseInt(bookid));
                    accountHelper.updateItem(Integer.parseInt(id),accountItem);
                    Intent intent1=new Intent(UpdateExpenses.this,DailyBill.class);
    ...
    void datePicker() {
        ...
        //datePicker相关
        datePicker = new DatePickerDialog(UpdateExpenses.this, null,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        remarks.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent1.setClass(UpdateExpenses.this,AddRemarks.class);
                intent1.putExtra("date",calendar.getText().toString());
                //startActivityForResult(intent1,0);
                UpdateExpenses.this.getParent().startActivityForResult(intent1,0);
            }
        });
        ...
        expensesTypeName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                LayoutInflater factor = LayoutInflater.from(UpdateExpenses.this);
                final View view_in = factor.inflate(R.layout.dialog, null);
                final AlertDialog.Builder alertDialog = new AlertDialog.Builder(UpdateExpenses.this);
