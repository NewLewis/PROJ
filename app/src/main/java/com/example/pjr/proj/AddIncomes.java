...
public class AddIncomes extends Activity implements OnTabActivityResultListener {
            ...
            public void onClick(View view) {
                ...
                if(pointFlag==false) {
                    ...
                    //超过位数
                        ...
                        Toast.makeText(AddIncomes.this,"最多只能输入七位整数", Toast.LENGTH_SHORT).show();
                    }
                }
                //输入小数点时
                else {
                    ...
                    //超过位数
                        ...
                        Toast.makeText(AddIncomes.this,"最多只能输入两位小数", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        ...
        point.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //输入过小数点时
                    ...
                    Toast.makeText(AddIncomes.this,"不能输入两次小数点", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        OK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //OK按钮时
                    ...
                    AccountItem accountItem=new AccountItem(-1,IN,incomesTypeName.getText().toString(),number,descrip,
                            Integer.parseInt(year1),Integer.parseInt(month1),Integer.parseInt(day1),bookid);
                    accountHelper.insertItem(accountItem);
                    Intent intent1=new Intent(AddIncomes.this,MiddleActivity.class);
    ...
    void datePicker() {
        ...
        //datePicker相关
        datePicker = new DatePickerDialog(AddIncomes.this, null,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        remarks.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent1.setClass(AddIncomes.this,AddRemarks.class);
                intent1.putExtra("date",calendar.getText().toString());
                //startActivityForResult(intent1,0);
                AddIncomes.this.getParent().startActivityForResult(intent1,0);
            }
        });
        ...
        incomesTypeName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                LayoutInflater factor = LayoutInflater.from(AddIncomes.this);
                final View view_in = factor.inflate(R.layout.dialog, null);
                final AlertDialog.Builder alertDialog = new AlertDialog.Builder(AddIncomes.this);
